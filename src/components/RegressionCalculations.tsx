...
export const RegressionCalculations: React.FC<RegressionCalculationsProps> = ({ data, onHighlight, highlightType }) => {
  ...
  return (
    <div className="regression-calculations">
      ...
      <div className={`calculation-box ${highlightType === 'slope' ? 'highlight-scp' : ''}`}>
        <h4>Slope Calculation (b₁)</h4>
      ...
      <div className={`calculation-box ${highlightType === 'intercept' ? 'highlight-scp' : ''}`}>
        <h4>Intercept Calculation (b₀)</h4>
        <div className="formula">
          <div style={{ marginBottom: '1rem' }}>
      ...
      <div className="calculation-box">
        ...
        <div className="formula">
          ...
          <div className="result r2-result" style={{ marginTop: '1rem' }} data-tooltip="R² (R-squared) measures the proportion of variance in the dependent variable that is explained by the independent variable. Values range from 0 to 1, where 1 indicates perfect prediction and 0 indicates no linear relationship.">
